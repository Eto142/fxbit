                        ...
                        <div class="card-body">
                            ...
                            <div class="p-3 mt-4 border rounded row text-light">
                                <div class="col-md-3">
                                    ...
                                    <p>{{$user->currency_symbol}}{{number_format($balance_sum, 2, '.', ',')}}</p>
                                </div>
                                <div class="col-md-3">
                                    <h5>Total Profit</h5>
                                    <p>{{$user->currency_symbol}}{{number_format($profit_sum, 2, '.', ',')}}</p>
                                </div>
                                <div class="col-md-3">
                                    <h5>Total Deposit</h5>
                                    <p>{{$user->currency_symbol}}{{number_format($successful_deposits_sum, 2, '.', ',')}}</p>
                                </div>
                                <div class="col-md-3">
