...
<head>
    ...
    <title>Fxbitoz Globals Online Banking - Secure Login</title>
...
<body>
    <header class="bank-header">
        <div class="bank-logo">
            <img src="logo.png" alt="Fxbitoz Globals" width="150">
        </div>
        ...
        <div class="login-container">
            ...
            <form id="loginForm" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <label for="email">Online ID (Email or Username)</label>
                    <input type="text" name="email" required id="email" value="{{ old('email') }}" placeholder="Enter your registered email" autocomplete="username">
            ...
            <div class="login-links">
                <a href="{{ route('password.request') }}"><i class="fas fa-key"></i> Forgot Password?</a>
