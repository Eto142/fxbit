                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Our Business Growth</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
                                    <li class="breadcrumb-item"><a href="portfolio1.html">News</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="single-portfolio-box1">
                            <div class="item-img">
                                <img src="{{ asset('img/portfolio/portfolio18.jpg') }}" alt="portfolio" width="1140" height="581">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="elfsight-app-9fabdfd6-d126-43dc-917a-13a120dc566c"></div>
                        </div>
                    </div>
        ...
        <section class="project-wrap-layout1 project-wrap-layout2">
            <div class="container">
                <p class="section-subtitle section-subtitle-sm"></p>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="project-box1">
                            <h2 class="section-title">Keep tabs on your credit score.</h2>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="project-box2">
                            <p>View your credit score for free anytime through TransUnion's CreditView™ Dashboard. Plus, get helpful tips on building and maintaining great credit.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="portfolio-box1">
                            <div class="item-img">
                                <a href="#"><img src="{{ asset('img/blog/blog5.jpg') }}" alt="blog" width="570" height="650"></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="portfolio-box1">
                            <div class="item-img">
                                <a href="#"><img src="{{ asset('img/blog/blog6.jpg') }}" alt="blog" width="570" height="650"></a>
                                <div class="item-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="portfolio-box1">
                            <div class="item-img">
                                <a href="#"><img src="{{ asset('img/blog/blog7.jpg') }}" alt="blog" width="570" height="650"></a>
                                <div class="item-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="portfolio-box1">
                            <div class="item-img">
                                <a href="#"><img src="{{ asset('img/blog/blog8.jpg') }}" alt="blog" width="570" height="650"></a>
                                <div class="item-content">
